  ...
  <div class="min-h-screen bg-gray-200 dark:bg-gray-900">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div class="px-4 py-6 sm:px-0">
        ...
        <!-- 내 모임 목록 (등록 + 대기열) -->
        <div
          class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 shadow rounded-lg overflow-hidden mt-6 border border-blue-200 dark:border-blue-800"
        >
          <div
            class="px-4 py-5 sm:px-6 border-b border-blue-200 dark:border-blue-700 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-800/30 dark:to-indigo-800/30"
          >
            <div class="flex items-center space-x-2">
              ...
              <div>
                ...
                <p class="mt-1 max-w-2xl text-sm text-blue-700 dark:text-blue-300">
          ...
          <div v-if="loadingRegistered || loadingWaitlist" class="px-4 py-5 sm:px-6 text-center">
            <svg
              class="animate-spin -ml-1 mr-3 h-8 w-8 text-blue-500 mx-auto"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            >
          ...
          <!-- 모임이 없는 경우 -->
          <div
            v-else-if="allMyMeetups.length === 0"
          ...
          <div v-if="!loadingRegistered && !loadingWaitlist && allMyMeetups.length > 0" class="hidden sm:block divide-y divide-blue-200 dark:divide-blue-700">
            <div
      ...
      >
        <div class="flex items-center justify-between mb-4">
          ...
          <button
            ...
            class="w-6 h-6 flex items-center justify-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded-full hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
          >
            <svg
              class="h-5 w-5"
              fill="none"
  ...
  >
    <div class="relative top-4 mx-auto p-0 max-w-6xl bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 max-h-[90vh] flex flex-col">
      ...
      <div class="flex-1 overflow-y-auto">
        ...
        <div v-if="selectedNotification" class="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 p-6">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
            <p class="text-gray-700 dark:text-gray-300 leading-relaxed whitespace-pre-line">{{ selectedNotification.message }}</p>
          </div>
        </div>
        ...
        <div class="p-6">
          ...
          <div v-else class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
            <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-600">
              ...
              <thead class="bg-gray-50 dark:bg-gray-700">
                <tr>
                  <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 dark:text-white sm:pl-6">상태</th>
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-white">유형</th>
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-white">제목</th>
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-white">모임</th>
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-white">시간</th>
              ...
              <tbody class="divide-y divide-gray-200 dark:divide-gray-600 bg-white dark:bg-gray-800">
                ...
                >
                  ...
                  <td class="px-3 py-4 text-sm text-gray-900 dark:text-white">
                    <div class="font-medium truncate max-w-xs" :title="notification.title">{{ notification.title }}</div>
                  </td>
                  <!-- Meetup -->
          ...
          <!-- Pagination -->
          <div v-if="notificationPagination.total > notificationPagination.per_page" class="mt-6 flex items-center justify-between border-t border-gray-200 dark:border-gray-700 pt-6">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p class="text-sm text-gray-700 dark:text-gray-300">
                  ...
                  <span class="font-medium">{{ (notificationPagination.current_page - 1) * notificationPagination.per_page + 1 }}</span> -
                  <span class="font-medium">{{ Math.min(notificationPagination.current_page * notificationPagination.per_page, notificationPagination.total) }}</span>개 표시
                </p>
              </div>
              <div>
