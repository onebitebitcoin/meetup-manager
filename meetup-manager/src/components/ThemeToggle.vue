<template>
  <button
    @click="toggleTheme"
    class="relative inline-flex items-center justify-center w-11 h-11 rounded-lg bg-beige-200 dark:bg-neutral-900 border border-beige-300 dark:border-neutral-800 transition-all duration-200 hover:border-primary-300 dark:hover:border-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-950 group"
  ...
  >
    ...
    <div class="absolute -top-1 -right-1 w-3 h-3 rounded-full bg-primary-500 dark:bg-primary-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
  </button>
</template>
