"""
Django settings for meetup_backend project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-d9y5umd6oac&virvd4^^t!3^zm6(+227@&0(%ts#2ztwrdt!-@')
...
ROOT_URLCONF = 'meetup_backend.urls'
...
WSGI_APPLICATION = 'meetup_backend.wsgi.application'
...
SITE_URL = os.environ.get('SITE_URL', 'http://localhost:8000' if DEBUG else 'https://meet.onebitebitcoin.com')
